<template>
  <div id="content">
    ...
    <Recipe id="assorteddecor:tarball" />
    ...
    <Recipe id="assorteddecor:asphalt" />
    ...
    <Recipe id="assorteddecor:roadway" />
    <p>You are also able to paint and clear the Roadway in a crafting table.</p>
    <div class="flex flex-wrap gap-4">
      <Recipe id="assorteddecor:roadway_orange" />
      <Recipe id="assorteddecor:roadway_wash" />
    </div>
    ...
    <div class="flex flex-wrap gap-4">
      <Recipe id="assorteddecor:roadway_manhole" />
      <Recipe id="assorteddecor:steel_roadway_manhole" />
    </div>
    ...
    <Recipe id="assorteddecor:roadway_light" />
    ...
    <Recipe id="assorteddecor:sidewalk" />
  </div>
</template>
