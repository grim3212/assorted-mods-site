<template>
  <section class="text-gray-200">
    <div class="max-w-6xl mx-auto px-5 py-10">
      ...
      <div class="block inline-flex w-full place-content-center">
        <a
...
import { ModDetails, getModDetails, Constants } from '../../util/mods'
...
export default defineComponent({
  ...
  computed: {
    details(): ModDetails {
      return getModDetails(this.mod)
    },
    curseUrl(): string {
      return Constants.CurseUrl + this.details.modId
    },
    modrinthUrl(): string {
      return Constants.ModrinthUrl + this.details.modId
    },
  },
})
</script>
