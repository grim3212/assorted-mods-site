<template>
  <div id="content">
    ...
    <p>
      ...
      your hand on them. To break frames use an axe for wooden and a pickaxe for the iron variant.
    </p>
    <img src="\src\assets\mods\decor\wood_frame_recipe.png" />
    <img src="\src\assets\mods\decor\iron_frame_recipe.png" />
    <p>
      Similar to
    ...
    <img src="\src\assets\mods\decor\frames.png" />
  </div>
</template>
