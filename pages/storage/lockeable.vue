<template>
  <div id="content">
    <h1><a name="lockeable_storage">Lockeable Storage</a></h1>
    <p>
      ...
      >
        Locksmith tools
      </NuxtLink>. All of these blocks also support hoppers and pipes to insert and export items.
    </p>
...
definePageMeta({
  pageTitle: 'Storage | Lockeable Storage'
})
</script>
