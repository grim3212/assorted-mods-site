<template>
  <div id="content">
    <h1><a name="chicken_suit">Chicken Suit</a></h1>
    <p>
    ...
    <p>
      ...
      book. Or using your already made <i>Chicken Suit</i> and combining it with another piece of
